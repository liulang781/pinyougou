...
public class GoodsDescServiceImpl implements GoodsDescService {
	...
	public PageResult findPage(int pageNum, int pageSize) {
        ...
        List<TbGoodsDesc> tbGoodsDescs = goodsDescMapper.selectByExample(null);
        PageInfo pageInfo = new PageInfo(tbGoodsDescs);
	...
	public PageResult findPage(TbGoodsDesc goodsDesc, int pageNum, int pageSize) {
		...
		if(goodsDesc!=null){
            ...
            List<TbGoodsDesc> tbGoodsDescs = goodsDescMapper.selectByExample(example);
            PageInfo pageInfo = new PageInfo(tbGoodsDescs);
            return new PageResult(pageInfo.getTotal(), pageInfo.getList());
	}
