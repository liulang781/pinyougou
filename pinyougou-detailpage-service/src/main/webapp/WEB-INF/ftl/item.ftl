					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<#list specificationItem.attributeValue as item>
								<dd>
									<a href="javascript:;"
									   class="{{isSelectSpecifcation('${specificationItem.attributeName}','${item}')?'selected':''}}"
									   ng-click="selectSpecifcation('${specificationItem.attributeName}','${item}')">${item}
